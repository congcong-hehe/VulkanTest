...
{
    // shader
    auto vertShaderCode = ReadFile("../../secondary_buffer/shaders/vert.spv");
    auto fragShaderCode = ReadFile("../../secondary_buffer/shaders/frag.spv");
...
void VulkanTest::CreateSecondaryCommandBuffer()
{
