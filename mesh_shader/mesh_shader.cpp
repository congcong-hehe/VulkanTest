...
VulkanTest::VulkanTest()
{
    ...
    vkCmdDrawMeshTasksEXT = reinterpret_cast<PFN_vkCmdDrawMeshTasksEXT>(vkGetDeviceProcAddr(m_Device, "vkCmdDrawMeshTasksEXT"));
}
...
void VulkanTest::CreateLogicalDevice()
{
    ...
    physicalDeviceFeatures2.pNext = static_cast<void *>(&enabledMeshShaderFeatures);
...
{
    // shader
    auto taskShaderCode = ReadFile("../../mesh_shader/shaders/task.spv");
    auto meshShaderCode = ReadFile("../../mesh_shader/shaders/mesh.spv");
    auto fragShaderCode = ReadFile("../../mesh_shader/shaders/frag.spv");
    ...
    std::vector<VkPipelineShaderStageCreateInfo> shaderStages = {taskShaderStageInfo, meshShaderStageInfo, fragShaderStageInfo};
